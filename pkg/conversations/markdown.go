...
func renderTextBlockMarkdown(msg StreamableMessage) string {
...
func mediaTypeFromDataURL(dataURL string) string {
	...
	trimmedDataURL := strings.TrimPrefix(dataURL, "data:")
	metadata := cutBefore(trimmedDataURL, ",")
	if metadata == trimmedDataURL {
		return ""
	}

	return cutBefore(metadata, ";")
}

func renderToolInvocationMarkdown(
	toolUse StreamableMessage,
	toolResult StreamableMessage,
	hasResult bool,
	toolResults map[string]tooltypes.StructuredToolResult,
...
func findMatchingToolResult(
	...
	return -1, StreamableMessage{}, false
}
...
func normalizeMarkdownOptions(opts MarkdownOptions) MarkdownOptions {
...
func renderRawToolPayloadMarkdown(content string, opts MarkdownOptions) string {
...
func prepareToolPayloadForMarkdown(value any, opts MarkdownOptions) (any, bool) {
...
func lookupStructuredToolResult(msg StreamableMessage, toolResults map[string]tooltypes.StructuredToolResult) (tooltypes.StructuredToolResult, bool) {
	if msg.ToolCallID != "" {
...
func inferToolNameFromResult(msg StreamableMessage, toolResults map[string]tooltypes.StructuredToolResult) string {
...
func cutBefore(value string, sep string) string {

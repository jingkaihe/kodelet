...
func (m *MockConversationStore) Query(_ context.Context, _ conversations.QueryOptions) (conversations.QueryResult, error) {
...
func TestCompactionHistoryAndResultsSurviveSaveLoadAndFork(t *testing.T) {
	thread := createTestThread()
	thread.messages = []openai.ChatCompletionMessage{
		{Role: openai.ChatMessageRoleUser, Content: "original question"},
		{
			Role: openai.ChatMessageRoleAssistant,
			ToolCalls: []openai.ToolCall{{
				ID:   "historic-tool",
		...
		{Role: openai.ChatMessageRoleTool, ToolCallID: "historic-tool", Content: "/workspace"},
		{Role: openai.ChatMessageRoleAssistant, Content: "original answer"},
	}
	...
	thread.messages = append(thread.messages,
		openai.ChatCompletionMessage{Role: openai.ChatMessageRoleUser, Content: "continued question"},
		openai.ChatCompletionMessage{Role: openai.ChatMessageRoleAssistant, Content: "continued answer"},
	)

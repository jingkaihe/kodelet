...
type ModelPricing struct {
	Input                float64
	Output               float64
	PromptCachingWrite5m float64
	PromptCachingWrite1h float64
...
var ModelPricingMap = map[anthropic.Model]ModelPricing{
	...
	anthropic.ModelClaudeFable5_1: {
		...
		PromptCachingRead:    0.00000025, // $0.25 per million tokens
		ContextWindow:        1_000_000,
	},
	...
	anthropic.ModelClaudeHaiku4_5: {
		...
		PromptCachingWrite5m: 0.00000125, // $1.25 per million tokens
		PromptCachingWrite1h: 0.000002,   // $2.00 per million tokens
	...
	modelClaude35Haiku: {
		...
		PromptCachingWrite5m: 0.000001,   // $1.00 per million tokens
		PromptCachingWrite1h: 0.0000016,  // $1.60 per million tokens
...
func getModelPricing(model anthropic.Model) ModelPricing {
	...
	if strings.Contains(lowerModel, "claude-sonnet-5") {
		...
		return ModelPricingMap[modelClaude35Haiku]
	}

...
func NewModel(ctx context.Context, conversationID string, enablePersistence bool, mcpManager *tools.MCPManager, maxTurns int, enableBrowserTools bool) Model {
	ta := textarea.New()
	...
	assistant := NewAssistantClient(ctx, conversationID, enablePersistence, mcpManager, maxTurns, enableBrowserTools)

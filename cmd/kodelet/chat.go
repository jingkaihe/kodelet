...
func init() {
	...
	chatCmd.Flags().BoolVar(&chatOptions.noSkills, "no-skills", false, "Disable agentic skills")
}
...
var chatCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, _ []string) {
		...
		tui.StartChatCmd(ctx, conversationID, !chatOptions.noSave, mcpManager, customManager, maxTurns, chatOptions.compactRatio, chatOptions.disableAutoCompact, chatOptions.ide, chatOptions.noSkills)

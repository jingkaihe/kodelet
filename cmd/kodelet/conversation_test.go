...
func TestRenderConversationMarkdownWithToolUseAndResult(t *testing.T) {
	messages := []conversations.StreamableMessage{
		{Kind: "text", Role: "user", Content: "Please inspect the repo"},
		{Kind: "tool-use", Role: "assistant", ToolName: "bash", ToolCallID: "call-1", Input: `{"command":"pwd","description":"Show cwd","timeout":10}`},
		{Kind: "tool-result", Role: "assistant", ToolName: "bash", ToolCallID: "call-1"},
	}

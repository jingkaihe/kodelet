...
func TestConversationListCommand(t *testing.T) {
	...
	cmd := exec.Command("../../bin/kodelet", "conversation", "list")
...
func TestConversationListWithOptions(t *testing.T) {
	...
	cmd := exec.Command("../../bin/kodelet", "conversation", "list", "--sort-by", "updated", "--sort-order", "desc")
	output, err := cmd.CombinedOutput()
	if err != nil {
...
func TestConversationShowInvalidID(t *testing.T) {
	...
	cmd := exec.Command("../../bin/kodelet", "conversation", "show", "invalid-id")
	output, err := cmd.CombinedOutput()
...
func TestConversationDeleteInvalidID(t *testing.T) {
	...
	cmd := exec.Command("../../bin/kodelet", "conversation", "delete", "--no-confirm", "invalid-id")
	output, err := cmd.CombinedOutput()
